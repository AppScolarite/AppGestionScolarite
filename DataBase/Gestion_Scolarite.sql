...
INSERT [dbo].[PROFESSEUR] ([Code_Pro_Nationnal], [Cin], [Nom], [Prenom], [Date_Naissance], [Date_Commencement_Contrat], [Type_Contrat], [Email], [Telephone], [sexe], [Adresse], [Situation_Familliale], [username], [mot_de_passe]) VALUES (N'P1', N'F123', N'El Ibrahimi', N'Israe', CAST(N'1995-01-01' AS Date), CAST(N'2020-02-28' AS Date), N'CDI', N'israe@gmail.com', N'0606060606', N'Femme', N'adresse1', N'Celibataire', N'israe', N'ctor123') --todo !
...
INSERT [dbo].[NOTE] ([matiere#], [Valeur_Note], [etudiant_]) VALUES (2, 15.5, N'H1197')
INSERT [dbo].[NOTE] ([matiere#], [Valeur_Note], [etudiant_]) VALUES (2, 12.75, N'H1197')
INSERT [dbo].[NOTE] ([matiere#], [Valeur_Note], [etudiant_]) VALUES (2, 14.00, N'H1197')
